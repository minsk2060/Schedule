...
В проекте реализуется возможность включения/выключения обрудования в определенное время 
по заданному расписанию автоматически.<br>
...
<tr>
    <td>flask</td>    
    <td colspan="2">- создание web сервера (частично необходим для работы с Viber)</td>
</tr>
<tr>
    <td>adding/</td>    
    <td colspan="2">- сторонные файлы для корректной работы проекта на устройстве:</td>
